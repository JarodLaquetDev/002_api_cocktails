...
return [
    ...
    'ingredientPictureDelete.update' => [['id'], ['_controller' => 'App\\Controller\\IngredientController::deletePictureInIngredient'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/api/ingredient_image_delete']], [], [], []],
    ...
    'instruction.update' => [['id'], ['_controller' => 'App\\Controller\\InstructionController::updateInstruction'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/api/instruction']], [], [], []],
    'instructionRecetteAdd.update' => [['id'], ['_controller' => 'App\\Controller\\InstructionController::addRecetteInInstruction'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/api/instruction_recette_add']], [], [], []],
    'instructionRecetteDelete.update' => [['id'], ['_controller' => 'App\\Controller\\InstructionController::deleteRecetteInInstruction'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/api/instruction_recette_delete']], [], [], []],
