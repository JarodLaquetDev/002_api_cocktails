 ...
 *          "instruction.get",
 *          parameters = {
 *              "idInstruction" = "expr(object.getId())"
 *          },
 *      ),
 *      exclusion = @Hateoas\Exclusion(groups="getAllInstructions")
 * )
 */
...
class Instruction
{
    ...
    #[Groups(["getAllInstructions","getInstruction", "getRecette", "getAllRecettes"])]
